...
// var words = [cat, dog, tiger, lion, monkey, rat, bear, goat, horse, river, truck, airplane, boat, building, garden, whale, shark, program, book];
...
function Hangman() {
    //Properties
    this.runGame = true;
    this.words = ['program', 'testing', 'Clayton', 'TECHCareers', 'cat', 'dog', 'tiger', 'lion', 'monkey', 'rat', 'bear', 'goat', 'horse', 'river', 'truck', 'airplane', 'boat', 'building', 'garden', 'whale', 'shark', 'program', 'book' ];
    this.word = '';
    this.displayString = '';
